...
# Machine-local secrets / API keys — kept OUT of the public dotfiles repo.
# Define exports in ~/.zshrc.local (gitignored); see README for the pattern.
[ -f "$HOME/.zshrc.local" ] && source "$HOME/.zshrc.local"

# bun completions
[ -s "/Users/anaypaul/.bun/_bun" ] && source "/Users/anaypaul/.bun/_bun"
